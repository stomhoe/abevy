...
pub fn plugin(app: &mut App) {
    ...
    .regrepli::<AcZ>()
    .regrepli::<MappedAnimations>()
    .regrepli::<OffsetForChildren>()
    .regrepli::<SpriteConfigNotFound>()
    .regrepli::<YSortOrigin>()
    .regrepli::<BaseHolderRef>()
    .regrepli::<MovementBased>()
    .regrepli::<GroundingBased>()
    .regrepli::<ExcludedFromNormalSizeModifier>()
