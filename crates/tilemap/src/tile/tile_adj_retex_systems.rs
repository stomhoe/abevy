...
pub fn tile_adjacency_dependent_retexturing_system(
    ...
    for msg in reader.read() {
        ...
        params.gather_tiles_at(&mut *locals.tiles_to_recheck, msg.dim, msg.gpos);
        for tile_ent in locals.tiles_to_recheck.drain(..) {
            ...
            params.gather_tiles_at(&mut *locals.north_adj_tiles_ezeros, dim, gpos.adjacent_north());
            params.gather_tiles_at(&mut *locals.south_adj_tiles_ezeros, dim, gpos.adjacent_south());
            params.gather_tiles_at(&mut *locals.west_adj_tiles_ezeros, dim, gpos.adjacent_west());
            params.gather_tiles_at(&mut *locals.east_adj_tiles_ezeros, dim, gpos.adjacent_east());
            params.gather_tiles_at(&mut *locals.northeast_adj_tiles_ezeros, dim, gpos.adjacent_northeast());
            params.gather_tiles_at(&mut *locals.northwest_adj_tiles_ezeros, dim, gpos.adjacent_northwest());
            params.gather_tiles_at(&mut *locals.southeast_adj_tiles_ezeros, dim, gpos.adjacent_southeast());
            params.gather_tiles_at(&mut *locals.southwest_adj_tiles_ezeros, dim, gpos.adjacent_southwest());
