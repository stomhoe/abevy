...
pub fn tile_readjust_transform(
    mut cmd: Commands,
    ezero_query: Query<&Transform, (With<Disabled>, Without<EntityZero>, Without<GlobalTilePos>)>,
    parent_query: Query<(&GlobalTransform, ), ()>,
    mut query: Query<(Entity, &mut Transform, &GlobalTilePos, Option<&ChildOf>, &EntityZero, Has<Replicated>, Has<KeepDisabled>),(With<Tile>, Or<(Changed<GlobalTilePos>, Changed<EntityZero>, Changed<ChildOf>, Added<Replicated>)>, Or<(Without<Disabled>, With<Disabled>, )>)>,
