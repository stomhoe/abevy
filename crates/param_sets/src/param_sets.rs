...
impl<'w, 's> BlockingTileParamSet<'w, 's> {
    ...
    pub fn is_blocked_at(&self, dim_ref: DimensionRef, gpos: GlobalTilePos, being: Entity) -> bool {
        ...
        for tile_entity in self.tile_gathering_params.gather_tiles_at(dim_ref, gpos) {
