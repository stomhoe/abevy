...
use common::{common_components::{Prefix, AppStateScoped}, common_tag_components::TagSet};
...
#[require(Replicated, ApplyMode::Offsetting, Prefix::trunc("Modifier"), AppStateScoped,)]
