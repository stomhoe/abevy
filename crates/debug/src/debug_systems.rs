...
use crate::debug_messages::{
    ClientDebugDecreaseSpeedRequest, ClientDebugIncreaseSpeedRequest, ClientDebugSetBeingCurrentBloodRequest,
    ClientDebugSetBeingCurrentHpRequest, ClientDebugSetBeingDimensionRequest, ClientDebugKillBeingRequest,
