...
use bevy::prelude::*;
use bevy_replicon::prelude::{ClientState, ClientTriggerExt, FromClient};
...
pub fn debug_numpad_speed_shortcuts(
    ...
    if *client_state.get() == ClientState::Connected {
        cmd.client_trigger(ClientDebugSetSpeedRequest { being_ent, speed });
    } else {
...
pub fn receive_client_debug_set_speed_request(
    request: On<FromClient<ClientDebugSetSpeedRequest>>,
    mut cmd: Commands,
    debug_ui_config: Query<&DebugUiConfig, With<SettingsEntity>>,
